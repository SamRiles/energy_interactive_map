...
class Production {
    public static void main(String[] args) {
    	...
    	String[] fuelCodes = {"COW", "GEO", "HYC", "NG", "NUC", "PEL", "SUN", "WND"};
    	
    	String fuelName = "";
    	
    	for(String fuelCode : fuelCodes) {
    		String csv = "";
    		fuelName = fuelCode + "_prod";
    ...
    public static String apiCall(String stateCode, String fuelName, String fuelCode) {
        ...
        try {
            String urlString = "http://api.eia.gov/series/?api_key=382f831445c6c53a5b349373e9804570&series_id=ELEC.GEN." + fuelCode + "-" + stateCode + "-98.A";
